...
# ---------------- ROUTES (UNCHANGED) ----------------
app.include_router(resumebuilder_router, prefix="/api/builder", tags=["resume-builder"])
...
app.include_router(dashboard_stream_router, prefix="/api/dashboard/stream", tags=["dashboard-stream"])
