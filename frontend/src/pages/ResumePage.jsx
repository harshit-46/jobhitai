...
const Icon = {
    ...
    check: (color = t.green, size = 20) => (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            <polyline points="20 6 9 17 4 12" />
        </svg>
    ),
    expand: (color = t.muted, size = 15) => (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    return (
        <div
            ...
            style={{
                ...
                padding: picked || uploading ? "16px 20px" : "28px 24px",
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                    ...
                    <div style={{ display: "flex", gap: 7, flexShrink: 0 }}>
                        <button onClick={(e) => { e.stopPropagation(); submit(); }} style={{
                            ...
                            boxShadow: "0 4px 14px rgba(232,255,71,0.22)",
    ...
    return (
        <div
            ...
            style={{
                ...
                animation: `fadeUp 0.4s ${index * 0.07}s cubic-bezier(0.22,1,0.36,1) both`,
                display: "flex", flexDirection: "column",
            }}
        >
            <div style={{ height: 1, background: `linear-gradient(90deg,transparent,${extColor}55,transparent)` }} />

            <div style={{
                height: 200, background: "#0d0d11",
                ...
                <div style={{
                    ...
                    <button
                        ...
                        style={{
                            ...
                            background: t.lime, color: "#0a0a0e",
                            border: "none", cursor: "pointer",
                            boxShadow: "0 4px 16px rgba(232,255,71,0.3)",
                        }}
                    >
                        {Icon.expand("#0a0a0e", 13)}
                        Open full
                    </button>
                </div>
            </div>
            ...
            <div style={{ padding: "14px 16px", display: "flex", alignItems: "center", gap: 10 }}>
                <div style={{
                    ...
                    background: `${extColor}10`, border: `1px solid ${extColor}22`,
                    display: "flex", alignItems: "center", justifyContent: "center",
                }}>
                    {Icon.file(extColor, 17)}
                </div>
                <div style={{ flex: 1, minWidth: 0 }}>
                    <p style={{
                ...
                <div style={{ display: "flex", gap: 6, flexShrink: 0 }}>
                    ...
                    <button
                        ...
                        onMouseEnter={e => { e.currentTarget.style.borderColor = "rgba(252,165,165,0.28)"; e.currentTarget.style.background = "rgba(252,165,165,0.06)"; }}
                        onMouseLeave={e => { e.currentTarget.style.borderColor = t.border; e.currentTarget.style.background = "transparent"; }}
                    >
                        {Icon.trash(t.faint, 13)}
                    </button>
                </div>
            </div>
        </div>
...
function ResumeCard({ resume, onDelete, index }) {
    ...
    const inlineUrl   = isPdf ? getInlineUrl(resume.url, resume.mime_type) : null;
    const downloadUrl = getDownloadUrl(resume.url, resume.filename, resume.mime_type);
        ...
        >
            ...
            <div style={{
                ...
                {isPdf && inlineUrl ? (
                    <>
                        {/* PDF iframe preview */}
                        <iframe
                            src={`${inlineUrl}#toolbar=0&navpanes=0&scrollbar=0`}
                            title={resume.filename}
                            style={{
                                width: "100%", height: "100%",
                                border: "none",
                    ...
                    /* No preview for DOC/DOCX */
                    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
                        {Icon.noPreview(t.faint, 32)}
                        <p style={{ fontSize: 11, color: t.faint, margin: 0 }}>No preview available</p>
                        <span style={{
            ...
            <div style={{ padding: "14px 16px", display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <div style={{ display: "flex", gap: 5, flexShrink: 0 }}>
                    {/* View — opens inline in new tab (PDF only) */}
                    {isPdf && inlineUrl && (
                        <ActionBtn
                            title="View"
                            onClick={() => window.open(inlineUrl, "_blank")}
                            hoverBorder={t.border2}
                            hoverBg={t.surface2}
                        >
                            {Icon.eye(t.muted, 13)}
                        </ActionBtn>
                    ...
                    {/* Download — downloads as original PDF/DOC */}
                    <a
                        href={downloadUrl}
                        ...
                        onMouseEnter={e => { e.currentTarget.style.borderColor = "rgba(232,255,71,0.3)"; e.currentTarget.style.background = "rgba(232,255,71,0.05)"; }}
                        onMouseLeave={e => { e.currentTarget.style.borderColor = t.border; e.currentTarget.style.background = "transparent"; }}
                    >
                        {Icon.download(t.muted, 13)}
                    </a>
                    ...
                    <ActionBtn
                        title="Delete"
                        onClick={() => onDelete(resume)}
                        hoverBorder="rgba(252,165,165,0.28)"
                        hoverBg="rgba(252,165,165,0.06)"
                    >
                        {Icon.trash(t.faint, 13)}
                    </ActionBtn>
                </div>
